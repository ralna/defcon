...
class DeflatedContinuation(object):
    ...
    def __init__(self, problem, deflation=None, teamsize=1, verbose=False, logfiles=False, strict=False):
        ...
        *Arguments*
        ...
        self.problemclass = problem.assembler_class()
    ...
    def worker(self, freeindex, values):
        ...
        while True:
            if isinstance(task, QuitTask):
                ...
                success = newton(self.residual, self.state, bcs, self.problemclass, self.teamno, self.deflation, snes_setup=self.problem.configure_snes)
